          ...
          <div className="h-full">
            ...
            {loading ? (
              ...
              <div className="px-4 pt-10 pb-60">
                ...
                {channel?.messages && channel.messages.length > 0 ? channel.messages.map((chat) => {
                  const messages = channel?.messages || [];
                  const currentIndex = messages.findIndex(m => m.id === chat.id); // find current message position
                  ...
                  const isFirstFromUser = prevMessage?.user?.id !== chat.user?.id;
                  return <MessageCard key={chat.id} continuesMessage={!isFirstFromUser} chat={chat} />
                }) : (
