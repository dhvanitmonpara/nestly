    ...
    <div className="bg-zinc-900 text-zinc-200 flex flex-col justify-center items-center h-screen w-screen">
      <div className="flex flex-col justify-center items-center space-y-6">
        <div className="flex flex-col justify-center items-center">
          <p className="text-lg">Server is spinning up. It will take 2-3 minutes.</p>
      ...
      <div className="pt-16 space-y-4 w-full px-4 flex flex-col justify-center items-center">
        <iframe src="https://hextris.io/" className="w-full rounded-2xl overflow-hidden max-w-5xl h-[600px]"></iframe>
        <h4>Play Hextris until the server is ready</h4>
      </div>
    </div>
  )
}
