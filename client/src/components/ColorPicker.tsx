...
function ColorPicker({ setUser, defaultColor }: { setUser: React.Dispatch<React.SetStateAction<IUser | null>>, defaultColor: string }) {
    ...
    return (
        <input className="h-6 w-10" type="color" name="profileColor" id="profileColor" value={localColor} onChange={(e) => setLocalColor(e.target.value)} />
    )
}
